...
public class Module {
  ...
  private final ModulePosition index;
  ...
  public record ModuleConfig(
      int driveCAN,
      int turnCAN,
      int absoluteEncoderCAN,
      Rotation2d absoluteEncoderOffset,
      boolean turnMotorInverted) {}

  public Module(ModuleIO io, ModulePosition index) {
    this.io = io;
    this.index = index;
  ...
  public void periodic() {
    Logger.processInputs("Drive/Module" + Integer.toString(index.ordinal()), inputs);
